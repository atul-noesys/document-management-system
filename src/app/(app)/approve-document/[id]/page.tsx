    ...
    const fetchData = async () => {
      ...
      if (response && (response as any).data) {
        const financeData = (response as any).data.filter(
          (item: Document) => item.ROWID.toString() === slug,
        );
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Smitha Bopanna">Smitha Bopanna</option>
                      <option value="Kiran H R">Kiran H R</option>
                    </select>
                  </div>
                </div>
                          ...
                          <p className="mb-2 text-sm text-gray-500">
                            <span className="font-semibold">
                              {selectedDoc?.attachment
                                ? selectedDoc?.attachment.slice(42)
                                : t("click_to_upload")}
                            </span>{" "}
                            {selectedDoc?.attachment
                              ? ""
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    >
                      <option value="">{t("enter_document_status")}</option>
